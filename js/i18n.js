(function () {
  ...
  const PAGE_CONTENT = {
    ...
    "about.s3.p": {
      fr: 'Les 29 roadmaps par compétence suivent une taxonomie standard de l\'industrie (langages, frameworks, outils, pratiques), cohérente avec les référentiels internationaux du secteur (dont <a href="https://roadmap.sh" target="_blank" rel="noopener">roadmap.sh</a>), pour rester alignées avec les attentes du marché au-delà du seul contexte togolais.',
      en: 'The 29 skill-based roadmaps follow a standard industry taxonomy (languages, frameworks, tools, practices), consistent with international references in the field (including <a href="https://roadmap.sh" target="_blank" rel="noopener">roadmap.sh</a>), to stay aligned with market expectations beyond the Togolese context alone.',
    },
    ...
    "faq.c1.a5": {
      fr: 'Un projet communautaire indépendant, sans statut commercial, créé et maintenu à titre personnel par <a href="https://www.linkedin.com/in/credoahiafor/" target="_blank" rel="noopener">Crédo Ahiafor</a> (<a href="https://github.com/GRIIINDER" target="_blank" rel="noopener">GitHub</a>), inspiré de <a href="https://roadmap.sh" target="_blank" rel="noopener">roadmap.sh</a> et adapté au contexte togolais. Détails dans <a href="about.html">À propos &amp; méthodologie</a> et les <a href="mentions-legales.html">mentions légales</a>.',
      en: 'An independent community project, with no commercial status, created and maintained personally by <a href="https://www.linkedin.com/in/credoahiafor/" target="_blank" rel="noopener">Crédo Ahiafor</a> (<a href="https://github.com/GRIIINDER" target="_blank" rel="noopener">GitHub</a>), inspired by <a href="https://roadmap.sh" target="_blank" rel="noopener">roadmap.sh</a> and adapted to the Togolese context. Details in <a href="about.html">About &amp; methodology</a> and the <a href="mentions-legales.html">legal notice</a>.',
    },
    ...
    "faq.c1.a10": {
      fr: 'Le site applique les bases : navigation au clavier, structure HTML lisible par un lecteur d\'écran, lien d\'évitement vers le contenu, et contrastes de couleur vérifiés. Ce n\'est pas (encore) un site audité pour l\'accessibilité (RGAA/WCAG) : certaines pages peuvent donc rester imparfaites avec un lecteur d\'écran ou un autre outil d\'assistance. Si tu rencontres un blocage, dis-le nous par email à <a href="mailto:wiya.info@gmail.com">wiya.info@gmail.com</a> : on corrige en priorité ce qui empêche réellement d\'utiliser le site.',
      en: 'The site covers the basics: keyboard navigation, screen-reader-friendly HTML structure, a skip link to the main content, and checked color contrast. It hasn\'t (yet) been audited for accessibility (WCAG), so some pages may still work imperfectly with a screen reader or other assistive tool. If you hit a blocker, let us know at <a href="mailto:wiya.info@gmail.com">wiya.info@gmail.com</a>: we\'ll prioritize fixing whatever actually prevents you from using the site.',
    },
    ...
    "eco.cy9.p": { fr: "Forum togolais dédié à la protection des données personnelles ; 2ᵉ édition tenue les 28-29 juillet 2026 à Lomé.", en: "Togolese forum dedicated to personal data protection; 2nd edition held July 28-29, 2026 in Lomé." },
